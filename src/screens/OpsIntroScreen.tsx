...
export const OpsIntroScreen = ({ navigation }: any) => {
  ...
  const handleLoginSubmit = () => {
    ...
    // Dummy auth check (any non-empty values will pass)
          ...
          >
            ...
            {!isLoginActive ? (
              <View style={styles.optionsContainer}>
                <TouchableOpacity
                  onPress={() => navigation.navigate('OpsSignup')}
                  activeOpacity={0.8}
                  style={styles.optionCard}
                >
                  <Text style={styles.cardText}>First time here? Register</Text>
                </TouchableOpacity>
              ...
              <View style={styles.formContainer}>
                ...
                <View style={styles.fieldContainer}>
                  <Text style={styles.inputLabel}>Enter your operator username</Text>
                  <TextInput
                    style={[
                      styles.textInput,
                ...
                <View style={styles.buttonContainer}>
                  ...
                  >
                    <Text style={[
                      ...
                      {step === 1 ? 'Proceed' : 'Login to Live Operations'}
                    </Text>
                  </TouchableOpacity>
                </View>
              </View>
